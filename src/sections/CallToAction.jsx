...
const CallToAction = () => {
  return (
    <section id="call-to-action" className="relative container bg-radial-[at_50%_100%] from-blue-950 from-20% to-blue-900 flex flex-col justify-center overflow-hidden">
      ...
      <h1 className="title text-6xl md:text-7xl text-center font-medium text-white z-20">
        Tunggu Apalagi?
      </h1>
      <p className="text-lg md:text-3xl md:leading-relaxed text-center text-gray-300 mt-5 z-20">
        Mulai langkah baru untuk membangun karier lebih percaya diri, terarah, dan penuh peluang.
      </p>
      <Button text="Daftar Sekarang" className="mt-7 md:mt-9 px-16 md:px-20 py-2 max-w-fit place-self-center z-20" />
    </section>
  )
}
